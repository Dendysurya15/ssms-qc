    ...
    <section class="content"><br>
        <div class="container-fluid">
            <div class="card table_wrapper p-4">
                <h2 style="color:#013C5E;font-weight: 550">Tambah User QC
                </h2>
                <hr>
                @if($errors->any())
                <div id="boxAlert">
                ...
                @endif
                <form action="{{route('store', ['lokasi_kerja' => session('lok')]) }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="departemen" disabled class="form-control" value="QC">
                    </div>
