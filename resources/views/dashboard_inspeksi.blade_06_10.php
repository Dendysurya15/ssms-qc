...
<style>
    ...
    .table-sticky-header thead th {
        ...
        /* match background color of the table header */
    }

    /* Add media query to target only mobile devices (e.g., devices with a screen width of 768px or less) */
    @media (max-width: 768px) {
        .table-sticky-header thead th {
            background-color: #f8f9fa;
            /* match background color of the table header */
            box-shadow: 0 2px 2px -1px rgba(0, 0, 0, 0.4);
            /* add a shadow to separate the header from the body */
        }
    }
