        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="width:30%;border:0;">
                    ...
                    <p style="text-align: left; font-size: 20px;">ESTATE-AFDELING : {{$item2['est']}}</p>
                    <p style="text-align: left; font-size: 20px;">TIPE-PERUMAHAN : {{$item2['tipe_rumah']}}</p>
                ...
                <td style="vertical-align: middle; text-align: right;width:40%;border:0;">
                    <div class="right-container">
                        <div class="text-container">
                            ...
                            <p style="text-align: right; font-size: 20px;">TANGGAL : {{$item2['tanggal']}}</p>
                            <p style="text-align: right; font-size: 20px;">Rumah DIPERIKSA : {{$item2['penghuni']}}</p>
        ...
        <table style="width: 100%; border-collapse: collapse; border: 1px solid black;">
            ...
            <body>
                ...
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai1']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen1']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Kontrol (Setiap bak mandi menggunakan pelampung)</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">4</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai2']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen2']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Lancar Keluar (saluran pembuangan air lancar)</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">4</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai3']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen3']}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai4']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen4']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Plafon (bersih dan tidak rusak)</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai5']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen5']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Dinding (bersih dan tidak rusak)</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai6']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen6']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Lantai (bersih dan tidak rusak)</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai7']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen7']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Kamar Mandi (bersih dan tidak rusak)</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai8']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen8']}}</td>
                </tr>
                <!-- listrik -->
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">4</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai9']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen9']}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">4</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai10']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen10']}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">4</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai11']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen11']}}</td>
                </tr>
                <!-- jemuran  -->
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai12']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen12']}}</td>
                </tr>
                <!-- Estetika  -->
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">3</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['perumahan_nilai13']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['perumahan_komen13']}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai1']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen1']}}</td>
                </tr>
                <!-- prroflie tank  -->
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">5</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai2']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen2']}}</td>
                </tr>
                <!-- TPA  -->
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai3']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen3']}}</td>
                </tr>
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai4']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen4']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Pagar</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai5']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen5']}}</td>
                </tr>
                <!-- mushola  -->
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai6']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen6']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Saluran Pembuangan air</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">1</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai7']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen7']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Kebersihan lingkungan</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai8']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen8']}}</td>
                </tr>
                <!-- drainase  -->
                <tr>
                    ...
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Bersih</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">3</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai9']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen9']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Lancar</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai10']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen10']}}</td>
                </tr>
                <!-- truk sampah  -->
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">4</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai11']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen11']}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">2</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai12']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen12']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Tidak ada penumpukan sampah</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">1</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai13']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen13']}}</td>
                </tr>
                <!-- parkir motor  -->
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">3</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['lingkungan_nilai14']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['lingkungan_komen14']}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['landscape_nilai1']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['landscape_komen1']}}</td>
                </tr>
                <!-- komposisi tanaman  -->
                <tr>
                    ...
                    <td colspan="1" style="text-align: center;border: 1px solid black;">5</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['landscape_nilai2']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['landscape_komen2']}}</td>
                </tr>
                <!-- pemilharaaan  -->
                <tr>
                    ...
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['landscape_komen3']}}</td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: left;border: 1px solid black;">Kebersihan Lingkungan</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">4</td>
                    <td colspan="1" style="text-align: center;border: 1px solid black;">{{$item2['landscape_nilai4']}}</td>
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['landscape_komen4']}}</td>
                </tr>
                <!-- design  -->
                <tr>
                    ...
                    <td colspan="5" style="text-align: left;border: 1px solid black;">{{$item2['landscape_komen5']}}</td>
                </tr>
                ...
                $total = $item2['total_nilailcp'] + $item2['total_nilailkng'] + $item2['total_nilairmh'] ;
                @endphp
                <tr>
